 ...
 * Data Se      {
      ...
      },
      {
        ...
        status: 'active' as const
      }reates sample data for testing data integrity features
 */
    ...
    const testComplaints = [
      {
        ...
        createdBy: 'test-sales-001',
        projectId: createdProjectIds[0] || 'default-project',
      ...
      },
      {
        ...
        createdBy: 'test-admin-001',
        projectId: createdProjectIds[1] || 'default-project',
