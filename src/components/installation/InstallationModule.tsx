    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center h-16">
            ...
            <h1 className="text-xl font-semibold text-gray-900">Installation</h1>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="card p-8 text-center">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Installation Module</h2>
          <p className="text-gray-600">
            This module will allow installation teams to update milestone statuses and upload daily photos.
          </p>
